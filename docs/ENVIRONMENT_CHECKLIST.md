...
|---|---:|---|---|
| Python | 3.11–3.13 | Local `Python 3.13.1`; `385 passed, 1 skipped` in 20.28s | Run 29639913312: 3.11, 3.12, and 3.13 PASS. |
| FastAPI | `>=0.115,<1` | Imported locally as `0.136.0`; the 385-test suite and browser suite pass | Run 29639913312: Python, browser, visual regression, and container jobs PASS. |
